...
def do_mortgage(additional, month):
    ...
    principal = 353.64 * pow(1.004, month)
...
def initialize():
    INITIAL_SAVINGS: Final = 42169   # Balance as of 2025-09-20
    INITIAL_MORTGAGE: Final = 208958 # Balance as of 2025-09-20
    INITIAL_ROOF: Final = 13138      # Balance as of 2025-09-20
...
# Low estimate from 2025-09-05 RMP email
TOTAL_DISTRIBUTION: Final = 1800
